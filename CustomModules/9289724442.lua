...
pcall(function()
	whitelisted = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/VapeMemorial/whitelists/main/whitelist2.json", true))
end)
			...
			if callback then
				...
				if not suc then
					...
					framebutton1.MouseButton1Click:connect(function()
						spawn(function()
							setclipboard("https://github.com/VapeMemorial/VapeV5/wiki/Turning-on-Highlights")
